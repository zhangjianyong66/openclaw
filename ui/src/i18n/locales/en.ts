...
export const en: TranslationMap = {
  ...
  config: {
    ...
    actions: {
      unsavedRawChanges: "Unsaved changes",
      unsavedChanges: {
    ...
    diff: {
      summary: {
        one: "View {count} pending change",
        other: "View {count} pending changes",
      },
    },
    subnav: {
      all: "All",
  ...
  nodes: {
    ...
    devices: {
      ...
      sectionPaired: "Paired",
      noDevices: "No paired devices.",
      roleValue: "role: {role}",
      roleUnknown: "role: -",
      repairTag: "repair",
      requestedAt: "requested {age}",
      approve: "Approve",
      reject: "Reject",
      roles: "roles: {roles}",
    ...
    bindings: {
      ...
      anyNode: "Any node",
      anyShort: "any",
      noBindingNodes: "No nodes with system.run available.",
      noAgents: "No agents found.",
      agentDefaultLabel: "default agent",
      agentLabel: "agent",
      usesDefault: "uses default ({value})",
      override: "override: {value}",
      bindingLabel: "Binding",
      bindingUseDefault: "Use default",
    },
    list: {
      paired: "paired",
      unpaired: "unpaired",
