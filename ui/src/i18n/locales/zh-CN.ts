...
export const zh_CN: TranslationMap = {
  ...
  config: {
    ...
    form: {
      ...
      formUnsafeWarning: "表单视图无法安全编辑部分字段，请使用“原始 JSON”以避免丢失配置。",
      rawLabel: "原始 JSON5",
    },
    validation: {
      valid: "有效",
  ...
  nodes: {
    ...
    bindings: {
      ...
      saving: "保存中…",
      save: "保存",
      rawModeWarning: "请将配置页切换到“表单”模式后再在此编辑绑定。",
      loadConfigHint: "加载配置以编辑绑定。",
      loadingConfig: "加载中…",
      loadConfig: "加载配置",
      defaultTitle: "默认绑定",
      defaultSubtitle: "当代理未单独指定节点绑定时使用此配置。",
      nodeLabel: "节点",
      anyNode: "任意节点",
      anyShort: "任意",
      noBindingNodes: "暂无可用 system.run 能力的节点。",
      noAgents: "未找到代理。",
      agentDefaultLabel: "默认代理",
      agentLabel: "代理",
      usesDefault: "使用默认（{value}）",
      override: "覆盖：{value}",
      bindingLabel: "绑定",
      bindingUseDefault: "使用默认值",
    },
    list: {
      paired: "已配对",
      unpaired: "未配对",
